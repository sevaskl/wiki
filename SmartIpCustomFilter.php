...
class SmartIpCustomFilter extends StringFilter {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    $form['turn_on_flag'] = [
      ...
      '#description' => $this->t('Filter Commerce Shops output data based on users country code and Shops billing countries.'),
  ...
  public function query() {
    ...
    //  $query->addJoin('commerce_store__billing_countries', 'bs', 'commerce_store_field_data.store_id = bs.entity_id');
    // $query->queueTable('commerce_store__billing_countries', 'bs', 'commerce_store_field_data.store_id = bs.entity_id');
